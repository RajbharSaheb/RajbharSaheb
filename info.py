...
URL = "https://miakhalifa-owyx.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://miakhalifa-owyx.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://miakhalifa-owyx.onrender.com/".format(FQDN)
else:
    URL = "https://miakhalifa-owyx.onrender.com/".format(FQDN)
