...
PICS = (environ.get('PICS', 'https://telegra.ph/file/ebad2eb29a3d2702e1531.jpg https://telegra.ph/file/5250452a1ab5364cfc4dc.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001930913574')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001930913574')
...
URL = "https://rajbharmv-7xdh.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://rajbharmv-7xdh.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://rajbharmv-7xdh.onrender.com/".format(FQDN)
else:
    URL = "https://rajbharmv-7xdh.onrender.com/".format(FQDN)
